...
<div class = "fixed w-full z-30 flex bg-white  p-2 items-center justify-between h-16 px-10">
        ...
        <div class = "grow h-full flex items-center justify-center " ></div>                    
                <div class = "flex-none h-full text-center flex space-x-10  items-center justify-center"> 
                    ...
                    <a href="/" class = "flex flex-col items-center px-3 mt-5">
                        ...
                        <div class = " md:block text-sm md:text-md text-black ">Admin</div>
                    </a>
              </div>
        </div>
    <aside class = "w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-white  ">
        ...
        <div onclick="openNav()" class = "-right-6 transition transform ease-in-out duration-500 flex border-4 border-white  hover:bg-blue-600 hover:bg-blue-500 bg-black absolute top-2 p-3 rounded-full text-white hover:rotate-45">
        ...
        <div class= "max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
            <a href="/dashboard/statistic" class =  "hover:bg-[#0000FF] w-full text-[#0000FF] hover:text-white hover:text-white hover:ml-3 border-2 border-white  p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
