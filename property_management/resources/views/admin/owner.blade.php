                        ...
                        @foreach ($owners as $owner)
                            <x-table.tr>
                                ...
                                <x-table.td>
                                    ...
                                    <button onclick="editOwner(`{{$owner->id}}`)"><x-icon name="update"/></button>
                                    </div>
                                </x-table.td>
                            </x-table.tr>     
                            

<div id="editOwner{{$owner->id}}" class="hidden min-w-screen h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover">
    ...
    @method('PUT')
        <div class=" flex flex-col gap-5">
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input value="{{$owner->name}}" type="text" name="name" id="name" class="block py-2.5 px-0 w-full text-md  bg-transparent border-0 border-b-2 border-[#0000FF] appearance-none  border-[#0000FF] focus:border-blue-300 focus:outline-none focus:ring-0  peer" placeholder=" "  />
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input value="{{$owner->CIN}}" type="text" name="CIN" id="CIN" class="block py-2.5 px-0 w-full text-md  bg-transparent border-0 border-b-2 border-[#0000FF] appearance-none  border-[#0000FF] focus:border-blue-300 focus:outline-none focus:ring-0  peer" placeholder=" "  />
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input value="{{$owner->phone}}" type="text" name="phone" id="phone" class="block py-2.5 px-0 w-full text-md  bg-transparent border-0 border-b-2 border-[#0000FF] appearance-none  border-[#0000FF] focus:border-blue-300 focus:outline-none focus:ring-0  peer" placeholder=" "  />
            ...
            <button onclick="editOwner()" class="text-white max-w-lg bg-red-600 hover:bg-white hover:text-red-600 border border-red-600 focus:ring-4 focus:ring-red-600 font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center ">Close</button>
...
<div id="addOwner" class="hidden min-w-screen h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover">
	...
	<form action="{{route('owners.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class=" flex flex-col gap-5">
            ...
            <div class="flex justify-end w-full space-x-10">	
            <button onclick="CreateOwner()" class="text-white max-w-lg bg-red-600 hover:bg-white hover:text-red-600 border border-red-600 focus:ring-4 focus:ring-red-600 font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center ">Close</button>
		<button type="submit" class="text-white max-w-lg bg-[#0000FF] hover:bg-white hover:text-[#0000FF] border border-[#0000FF] focus:ring-4 focus:ring-[#0000FF] font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center ">Save</button>
        </div>	
    </form>
    </div>
