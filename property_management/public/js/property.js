...
function validateAndSubmitEditForm(propertyId) {
    ...
    var local = form.querySelector('#local-edit');
    var price = form.querySelector('#price-edit');
    var description = form.querySelector('#description-edit');
    var owner = form.querySelector('#owner-edit');

   
    // Error elements
    var imageError = form.querySelector('#image-error-edit');
    var titleError = form.querySelector('#title-error-edit');
    var localError = form.querySelector('#local-error-edit');
    var priceError = form.querySelector('#price-error-edit');
    var descriptionError = form.querySelector('#description-error-edit');
    var ownerError = form.querySelector('#owner-error-edit');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    editForms.forEach(function(form) {
        var propertyId = form.dataset.propertyId;
